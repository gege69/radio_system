        ...
        <div class="panel-body">
          ...
          <div class="row">
            <div class="col-lg-6 col-md-6">
              <h3><i class="${func.sizeSmall} ${func.classesIcone}">${func.icone}</i> Relatórios</h3>
              <h4><small>Acompanhe a execução das mídias</small></h4>
            </div>
          ...
          <form action="#" id="formRelatorios" class="form-inline" >
            ...
            <div class="form-group">
              <label class="control-label" for="combocategoria">Tipo de Mídia:</label>
              <select class="form-control" id="combocategoria" name="categoria[idCategoria]" >
                <option value="" selected>Todas as mídias</option>
              </select>
            </div>
            ...
            <div class="form-group">
                <a class="btn btn-primary text-center" href="#" id="btnGerar"> <i class="fa fa-newspaper-o"></i> Gerar Relatório</a>
            </div>
